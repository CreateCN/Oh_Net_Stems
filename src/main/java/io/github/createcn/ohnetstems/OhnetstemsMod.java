package io.github.createcn.ohnetstems;
...
public class OhnetstemsMod {
	public static final Logger LOGGER = LogManager.getLogger(OhnetstemsMod.class);
	public static final String MODID = "ohnetstems";

	public OhnetstemsMod() {
